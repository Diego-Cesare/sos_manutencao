    ...
    <div className="main">
      ...
      <form onSubmit={sendEmail}>
        <div className="unidade">
          <label htmlFor="">
            <BuildingOffice weight="duotone" /> Unidade
          </label>
          <input
            type="text"
        ...
        <div className="info">
          <div className="end">
            <label htmlFor="">
              <MapPin weight="duotone" /> Endereço
            </label>
            <input type="text" placeholder="Bairro" required name="endereco" />
          </div>
          <div className="tel">
            <label htmlFor="">
              <Phone weight="duotone" /> Telefone
            </label>
          ...
          <div className="menu">
            <nav>
              ...
              <a
                className="item"
                href="#"
                onClick={() => selectTipe("Hidráulica")}
              >
                <Drop weight="duotone" />
              </a>
              <a className="item" href="#" onClick={() => selectTipe("Esgoto")}>
                <Pipe weight="duotone" />
              </a>
              <a
                className="item"
                href="#"
                onClick={() => selectTipe("Estrutural")}
              >
              ...
              <a
                className="item"
                href="#"
                onClick={() => selectTipe("Carpintaria")}
              >
              ...
              <a
                className="item"
                href="#"
                onClick={() => selectTipe("Limpeza")}
              >
                <Broom weight="duotone" />
              </a>
              <a className="item" href="#" onClick={() => selectTipe("Outros")}>
        ...
        <input
          id="tipo"
          type="text"
          placeholder="Aceita apenas 1 item!"
          required
          name="tipo"
        />
        ...
        <button onClick={valideTipo} type="submit">
          Enviar
        </button>
      </form>
    </div>
